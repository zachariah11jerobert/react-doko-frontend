            ...
            >
                ...
                <div class="row">
                  ...
                  >
                    <ul className="list-group list-group-flush inline_blog_style1">
                      ...
                      >
                        <span className="inline_blog_style4">25 mg</span>

                        <span className="inline_blog_style5">
                          <span className="inline_blog_style10">
                            <span style={{ color: "black" }}>$2</span>
                          </span>
                          <span className="inline_blog_style6"> $1</span>
                        </span>
                      </li>
              ...
              >
                ...
                <p class="card-text">
                  ...
                  <b style={{ color: "#009688" }}> 25mg</b>,{" "}
                  <b style={{ color: "#009688" }}>50mg</b> and{" "}
                  <b style={{ color: "#009688" }}>100mg</b> strength.
                </p>
                <a
                  href="#edform"
            ...
            >
                  ...
                  >
                    <ul className="list-group list-group-flush inline_blog_style8">
                      ...
                      >
                        ...
                        <span className="inline_blog_style4">
                          <span className="inline_blog_style10">
                            <span style={{ color: "black" }}>$2</span>
                          </span>{" "}
                          <span className="inline_blog_style6"> $1</span>
              ...
              <div class="card-body" style={{ textAlign: "center" }}>
                ...
                <p class="card-text">
                  ...
                  <b style={{ color: "#009688" }}>5mg</b>,{" "}
                  <b style={{ color: "#009688" }}>10mg</b> and{" "}
                  <b style={{ color: "#009688" }}>20mg</b> strength.
                </p>
                <a
                  href="#edform"
                  class="btn solid-btn page-scroll getitnow"
